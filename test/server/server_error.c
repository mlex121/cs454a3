...
int main(int argc, char *argv[]) {
    ...
    int un_init = rpcRegister("f0", argTypes0, *f0_Skel);
    printf("Registration called before init, received: %d\n", un_init);
    ...
    int re_init = rpcInit();
    printf("Init called twice, received: %d\n", re_init);
    ...
    int fail = rpcRegister("f0", argTypes0, *f0_Skel);
    printf("Registration call after execution returned: %d\n", fail);
